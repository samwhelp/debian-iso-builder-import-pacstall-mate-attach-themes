...
REF_WORK_DIR_PATH="${HOME}/work/debian-iso-builder-import-pacstall-mate-attach-themes"
...
echo "[Next Step]: cd ~/work/debian-iso-builder-import-pacstall-mate-attach-themes/iso-profile
"
echo
